...
void lotInventory(carDetails pCar[], int pSize)
{
    ...
    cout << "************************************ " << endl;
    cout << setw(12) << left << "Make: " << setw(12) << left <<  "Model: " << setw(8) << left << "Year: " << setw(1) << left << "Price: " << endl;
    for (int i = 0; i < ARRAY_SIZE; i++)
    {   
        cout << setw(12) << left << pCar[i].Make << setw(12) << left << pCar[i].Model << setw(8) << left << pCar[i].Year << setw(1) << left << "$" << pCar[i].price << endl;
    }
}
//-------------------------------------------------------------------------------------------------------
