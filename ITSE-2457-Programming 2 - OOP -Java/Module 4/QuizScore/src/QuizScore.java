...
public class QuizScore {
    ...
    // If the user enters a grade less than 50, the setter function should be set to
    // 50
    // If the user enters a grade above 100, the setter should be set the grade to
    // 100
    ...
    // and a method that returns the letter grade assigned for the test score
    // average
    // Class will have a method to return a character based on student’s letter
    // grade
    ...
    public String PrintInfo() {
        String myReturn = "";
        myReturn = "\n" + this.studentName + "'s Quiz Scores: \n";
